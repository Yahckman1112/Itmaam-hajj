...
function Packages() {
    ...
    // const progress = (ragisteredClient/totalSpace)
    const progress = (123/150)*100
  return (
    <div>
        <div>
        ...
        <section className='p-20 min-h-screen'>
            ...
            {packageData.map((item:any,i:any)=>(
                ...
                <div className='rounded-lg border border-solid  ' key={i}>
                    ...
                    <div className='grid grid-cols-2 my-7 ' style={{gridTemplateColumns:'20% 80%'}}>
                        ...
                        <div >
                            ...
                            <p className='text-[15px] font-bold text-[#007bff] '>{item.time} MIN To Masjidil Haram</p>
                        </div>
                    ...
                    <div className='grid grid-cols-2 my-7' style={{gridTemplateColumns:'20% 80%'}}>
                        ...
                        <div >
                            <p className='text-[15px] font-semibold mb-1 '>MAKKAH : Hotel Name</p>
                            <p className='text-[15px] font-bold text-[#007bff] '>{item.time} MIN To Nabawi Mosque</p>
                        </div>

                    </div>


                    <p className='text-[#007bff] text-2xl font-semibold my-12 mb-7' > <span className='text-[#929191] line-through text-lg font-normal'>{item.lastPrice} USD/P</span> {item.currentPrice} USD/P </p>
                        ...
                        <div className='my-9 border border-solid border-t-1 border-b-0 border-r-0 border-l-0 pt-7 p-3'>
                            ...
                            < ProgressBar completed={(item.registeredClient/item.totalSpace)*100} />

                            </div>
                            <p className='mt-3 text-xs font-semibold'>Booked : {item.registeredClient}/{item.totalSpace}</p>
                        </div>
                </div>
            ))}
