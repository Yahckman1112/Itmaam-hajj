  ...
  return (
    ...
    <div className=" pt-12 px-9">
      {AuthNav.map((item: any, i: any) => (
        <Link key={i} to="#" className={` font-semibold  text-base `}>
          <div
      ...
      <div className="  mx-2 p-5 text-center border border-dashed border-[#7C7C7A] min-h-[100px]">
       <div className="py-2 px-2 flex m-auto text-white cursor-pointer bg-[#1A8F4A] w-fit" style={{borderRadius:'100%'}}>
     < FaPlus />
       </div>

       <div className="text-[#262627] font-[open-sans] text-base font-bold leading-8">Add new Admin</div>
       <div> </div>
      </div>
    </>
  );
